...
class BorsdataAPI:
    ...
    @staticmethod
    def _set_index(df, index, new_index_name=None, ascending=True):
        """
        ...
        if new_index_name is not None:
            assert type(new_index_name) != list()
    ...
    def _get_base_params(self):
        ...
        return {
            ...
            "version": 1,
            'maxYearCount': self._params["maxYearCount"],
            'maxR12QCount': self._params["maxR12QCount"],
            'maxCount': self._params["maxCount"]
        }
    ...
    def get_instrument_report(self, ins_id, report_type, max_count=None):
        ...
        # self._set_index(df, ["year", "period"]
        self._set_index(df, "reportDate", "datetime", ascending=True)
        return df
    ...
    def get_instrument_stock_prices(self, ins_id, from_date=None, to_date=None, max_count=None):
        ...
        self._set_index(df, "date", "datetime", ascending=True)
        return df
